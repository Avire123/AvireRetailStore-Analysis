...
st.set_page_config(layout="wide",
                   ...
                   page_icon="$",
                   page_title='Avire Stores Dashboard')
...
st.sidebar.header('Avire Stores')
...
if selection == 'Business Snapshot':
    ...
    missing = df.isnull().sum().reset_index(name='No of missing values')
    missing = missing.rename(columns={"index": "Columns"})
...
<div class="container">
Made by <a class="white-text text-lighten-3" href="https://africadataschool.com/">Avire </a><br/>
